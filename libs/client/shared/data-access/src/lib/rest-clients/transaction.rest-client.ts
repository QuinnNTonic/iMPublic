...
export class TransactionRestClient {
  ...
  getForProfile(query: IQuery<Transaction>, dto: GetTransactionsForProfileDto) {
    ...
    return this.http.post<IParser<Transaction, typeof TransactionQuery>[]>(
      `${this.apiUrl}/getForProfile`,
      body
    );
  }
  ...
  transaction(query: IQuery<Transaction>, dto: TransactionDto) {
    ...
    return this.http.post<IParser<Transaction, typeof TransactionQuery>>(`${this.apiUrl}/transaction`, body);
  }
}
