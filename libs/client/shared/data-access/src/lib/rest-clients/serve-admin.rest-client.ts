...
export class ServeAdminRestClient {
  ...
  getForServePartner(query: IQuery<ServeAdmin[]>, dto: GetServeAdminsForServePartnerDto) {
    ...
    return this.http.post<IParser<ServeAdmin, typeof SpAdminQuery>[]>(
      `${this.apiUrl}/getForServePartner`,
      body
    );
  }
  ...
  addAdmin(query: IQuery<ServeAdmin>, dto: AddServeAdminDto) {
    ...
    return this.http.post<IParser<ServeAdmin, typeof SpAdminQuery>>(`${this.apiUrl}/addAdmin`, body);
  }
