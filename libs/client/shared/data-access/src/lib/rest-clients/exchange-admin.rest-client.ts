...
export class ExchangeAdminRestClient {
  ...
  getForExchangePartner(query: IQuery<ExchangeAdmin>, dto: GetExchangeAdminsForExchangePartnerDto) {
    ...
    return this.http.post<IParser<ExchangeAdmin, typeof EpAdminQuery>[]>(
      `${this.apiUrl}/getForExchangePartner`,
      body
    );
  }
  ...
  getSuperAdminForExchangePartner(query: IQuery<ExchangeAdmin>, dto: GetSuperAdminForExchangePartnerDto) {
    ...
    return this.http.post<IParser<ExchangeAdmin, typeof BaDownloadEpAdminsQuery>>(
      `${this.apiUrl}/getSuperAdminForExchangePartner`,
      body
    );
  }
  ...
  addAdmin(query: IQuery<ExchangeAdmin>, dto: AddExchangeAdminDto) {
    ...
    return this.http.post<IParser<ExchangeAdmin, typeof EpAdminQuery>>(`${this.apiUrl}/addAdmin`, body);
  }
