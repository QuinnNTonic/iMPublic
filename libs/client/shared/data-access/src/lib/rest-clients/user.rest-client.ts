...
export class UserRestClient {
  ...
  verifyUserEmail(query: IQuery<typeof VerifyUserEmailQuery>, dto: VerifyUserEmailDto) {
    ...
    return this.http.post<IParser<typeof VerifyUserEmailQuery, typeof VerifyUserEmailQuery>>(
      `${this.apiUrl}/verifyUserEmail`,
      body
    );
  }
  ...
  signUp(query: IQuery<{ token: string }>, dto: SignUpDto) {
    ...
    return this.http.post<IParser<{ token: string }, { token: string }>>(`${this.apiUrl}/signUp`, body);
  }
  ...
  login(query: IQuery<{ token: string }>, dto: LoginDto) {
    ...
    return this.http.post<IParser<{ token: string }, { token: string }>>(`${this.apiUrl}/login`, body);
  }
  ...
  adminLogin(query: IQuery<{ token: string }>, dto: AdminLoginDto) {
    ...
    return this.http.post<IParser<{ token: string }, { token: string }>>(`${this.apiUrl}/adminLogin`, body);
  }
  ...
  validateAdminToken(query: IQuery<{ token: string }>, dto: ValidateAdminDto) {
    ...
    return this.http.post<IParser<{ token: string }, { token: string }>>(
      `${this.apiUrl}/validateAdminToken`,
      body
    );
  }
  ...
  getUserData(query: IQuery<User>) {
    ...
    return this.http.post<IParser<User, typeof UserQuery>>(`${this.apiUrl}/getUserData`, body);
  }
  ...
  snoop(query: IQuery<ISnoopData>, dto: SnoopDto) {
    ...
    return this.http.post<IParser<ISnoopData, { token: string } & typeof UserQuery>>(
      `${this.apiUrl}/snoop`,
      body
    );
  }
  ...
  getAllUserPrivileges(query: IQuery<User[]>) {
    ...
    return this.http.post<IParser<User, typeof UserPrivilegeQuery>[]>(
      `${this.apiUrl}/getAllUserPrivileges`,
      body
    );
  }
  ...
  grantBAPrivilege(query: IQuery<User>, dto: GrantBaPrivilegesDto) {
    ...
    return this.http.post<IParser<User, typeof UserPrivilegeQuery>>(`${this.apiUrl}/grantBAPrivilege`, body);
  }
  ...
  revokeBAPrivilege(query: IQuery<User>, dto: RevokeBaPrivilegesDto) {
    ...
    return this.http.post<IParser<User, typeof UserPrivilegeQuery>>(`${this.apiUrl}/revokeBAPrivilege`, body);
  }
  ...
  searchUsers(query: IQuery<User[]>, dto: SearchUserDto) {
    ...
    return this.http.post<IParser<User, typeof UserSearchQuery>[]>(`${this.apiUrl}/searchUsers`, body);
  }
  ...
  activateUserAccount(query: IQuery<Record<string, never>>, dto: ActivateUserAccountDto) {
    ...
    return this.http.post<IParser<Record<string, never>, Record<string, never>>>(
      `${this.apiUrl}/activateUserAccount`,
      body
    );
  }
  ...
  resendEmailVerificationEmail(query: IQuery<Record<string, never>>, dto: ResendEmailVerificationEmailDto) {
    ...
    return this.http.post<IParser<Record<string, never>, Record<string, never>>>(
      `${this.apiUrl}/resendEmailVerificationEmail`,
      body
    );
  }
  ...
  forgotPasswordChange(query: IQuery<Record<string, never>>, dto: ForgotPasswordChangeDto) {
    ...
    return this.http.post<IParser<Record<string, never>, Record<string, never>>>(
      `${this.apiUrl}/forgotPasswordChange`,
      body
    );
  }
  ...
  adminUserSearch(query: IQuery<User[]>, dto: AdminUserSearchDto) {
    ...
    return this.http.post<IParser<User, typeof AdminUserSearchQuery>[]>(
      `${this.apiUrl}/adminUserSearch`,
      body
    );
  }
}
