...
export class RequestRestClient {
  ...
  query(query: IQuery<Request[]>, dto: QueryRequestsDto) {
    ...
    return this.http.post<IPagination<IParser<Request, typeof RequestMarketQuery>>>(
      `${this.apiUrl}/query`,
      body
    );
  }
  ...
  getOne(query: IQuery<Request>, dto: GetOneRequestDto) {
    ...
    return this.http.post<IParser<Request, typeof RequestMarketQuery>>(`${this.apiUrl}/getOne`, body);
  }
  ...
  getForProfile(query: IQuery<Request[]>, dto: GetRequestsForProfileDto) {
    ...
    return this.http.post<IParser<Request, typeof RequestQuery>[]>(`${this.apiUrl}/getForProfile`, body);
  }
  ...
  create(query: IQuery<Request>, dto: CreateRequestDto) {
    ...
    return this.http.post<IParser<Request, typeof RequestQuery>>(`${this.apiUrl}/create`, body);
  }
  ...
  update(query: IQuery<Request>, dto: UpdateRequestDto) {
    ...
    return this.http.post<IParser<Request, typeof RequestQuery>>(`${this.apiUrl}/update`, body);
  }
  ...
  uploadImages(query: IQuery<Request>, dto: UploadRequestImageDto, files: File[]) {
    ...
    return this.http.post<IParser<Request, typeof RequestQuery>>(`${this.apiUrl}/uploadImages`, body, {
      reportProgress: true,
      observe: 'events',
    });
  }
  ...
  deleteImage(query: IQuery<Request>, dto: DeleteRequestImageDto) {
    ...
    return this.http.post<IParser<Request, typeof RequestQuery>>(`${this.apiUrl}/deleteImage`, body);
  }
}
