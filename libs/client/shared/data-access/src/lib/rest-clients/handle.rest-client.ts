...
export class HandleRestClient {
  ...
  verifyHandle(query: IQuery<{ isUnique: boolean }>, dto: VerifyHandleDto) {
    ...
    return this.http.post<IParser<{ isUnique: boolean }, { isUnique: boolean }>>(
      `${this.apiUrl}/verifyHandle`,
      body
    );
  }
  ...
  searchHandles(query: IQuery<Handle>, dto: SearchHandleDto) {
    ...
    return this.http.post<IParser<Handle, typeof HandleChatQuery>[]>(`${this.apiUrl}/searchHandles`, body);
  }
  ...
  viewProfile(query: IQuery<Handle>, dto: ViewProfileDto) {
    ...
    return this.http.post<IParser<Handle, typeof ViewProfileInfoQuery>>(`${this.apiUrl}/viewProfile`, body);
  }
  ...
  genericSearch(query: IQuery<Handle>, dto: GenericHandleSearchDto) {
    ...
    return this.http.post<IParser<Handle, typeof GenericHandleSearchQuery>[]>(
      `${this.apiUrl}/genericSearch`,
      body
    );
  }
}
