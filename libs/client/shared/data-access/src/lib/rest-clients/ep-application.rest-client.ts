...
export class EpApplicationRestClient {
  ...
  submit(query: IQuery<EpApplication>, dto: SubmitEpApplicationDto) {
    ...
    return this.http.post<IParser<EpApplication, typeof EpApplicationQuery>>(`${this.apiUrl}/submit`, body);
  }
  ...
  baSubmit(query: IQuery<ExchangePartner>, dto: BaSubmitEpApplicationDto) {
    ...
    return this.http.post<IParser<ExchangePartner, typeof EpApplicationQuery>>(
      `${this.apiUrl}/baSubmit`,
      body
    );
  }
  ...
  findAll(query: IQuery<EpApplication[]>) {
    ...
    return this.http.post<IParser<EpApplication, typeof EpApplicationQuery>[]>(
      `${this.apiUrl}/findAll`,
      body
    );
  }
