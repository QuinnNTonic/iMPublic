...
export class ProjectRestClient {
  ...
  getAll(query: IQuery<Project[]>, dto: ProjectsQueryDto) {
    ...
    return this.http.post<IPagination<IParser<Project, typeof ProjectFeedQuery>>>(
      `${this.apiUrl}/getAll`,
      body
    );
  }
  ...
  getOne(query: IQuery<Project>, dto: GetProjectDto) {
    ...
    return this.http.post<IParser<Project, typeof ProjectFeedQuery>>(`${this.apiUrl}/getOne`, body);
  }
  ...
  getAllOwnedBySp(query: IQuery<Project[]>, dto: ProjectsSpDto) {
    ...
    return this.http.post<IParser<Project, typeof ProjectSpQuery>[]>(`${this.apiUrl}/getAllOwnedBySp`, body);
  }
  ...
  create(query: IQuery<Project>, dto: CreateProjectDto) {
    ...
    return this.http.post<IParser<Project, typeof ProjectSpQuery>>(`${this.apiUrl}/create`, body);
  }
  ...
  update(query: IQuery<Project>, dto: UpdateProjectDto) {
    ...
    return this.http.post<IParser<Project, typeof ProjectSpQuery>>(`${this.apiUrl}/update`, body);
  }
  ...
  uploadImages(query: IQuery<Project>, dto: UploadProjectImageDto, images: File[]) {
    ...
    return this.http.post<IParser<Project, typeof ProjectSpQuery>>(`${this.apiUrl}/uploadImages`, body, {
      reportProgress: true,
      observe: 'events',
    });
  }
  ...
  deleteImage(query: IQuery<Project>, dto: DeleteProjectImageDto) {
    ...
    return this.http.post<IParser<Project, typeof ProjectSpQuery>>(`${this.apiUrl}/deleteImage`, body);
  }
  ...
  delete(query: IExactQuery<{ deletedId: string }, { deletedId: true }>, dto: DeleteProjectDto) {
    ...
    return this.http.post<IParser<{ deletedId: string }, { deletedId: true }>>(`${this.apiUrl}/delete`, body);
  }
  ...
  uploadCustomWaiver(query: IQuery<Project>, dto: UploadCustomWaiverDto, waiver: File) {
    ...
    return this.http.post<IParser<Project, typeof ProjectSpQuery>>(
      `${this.apiUrl}/uploadCustomWaiver`,
      body,
      {
        reportProgress: true,
        observe: 'events',
