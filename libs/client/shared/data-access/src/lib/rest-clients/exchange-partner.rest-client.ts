...
export class ExchangePartnerRestClient {
  ...
  query(query: IQuery<ExchangePartner>, dto: ExchangePartnerMarketQueryDto) {
    ...
    return this.http.post<IParser<ExchangePartner, typeof ExchangePartnerMarketQuery>[]>(
      `${this.apiUrl}/query`,
      body
    );
  }
  ...
  editProfile(query: IQuery<ExchangePartner>, dto: EditEpProfileDto) {
    ...
    return this.http.post<IParser<ExchangePartner, typeof UserQuery.exchangeAdmins.exchangePartner>>(
